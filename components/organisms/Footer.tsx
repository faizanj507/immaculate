      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-b border-white/10 pb-12 mb-12">
          ...
          <nav className="flex flex-wrap justify-center gap-8">
            ...
            <a href="mailto:hello@immaculateclean.com" className="text-sm font-bold uppercase tracking-widest hover:text-primary transition-colors">hello@immaculateclean.com</a>
          </nav>
          ...
          <div className="flex gap-6">
            ...
            <a href="https://goo.gl/maps/utMEjRMW2mtmdGDA7" target="_blank" rel="noopener noreferrer" className="text-white hover:text-primary transition-colors" title="Google Maps">
